...
def translate_vivqa_data(input_json):
...
def translate_one_vivqa_item(org_item, output_lines_json, translated_ids, translated_data, failed_translations, \
    ...
    try:
        if org_item["question"]:
            org_item["question"] = ggl_translator.translate(org_item["question"])
...
if __name__ == "__main__":
    ...
    vivqa_split_files = [
        # "data/vivqa/original/train.json",
        "data/vivqa/original/test.json"
    ]
    for json_path in vivqa_split_files:
        translate_vivqa_data(json_path)